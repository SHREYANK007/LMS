      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
          <p className="text-red-800 text-sm">
            <strong>Warning:</strong> This action cannot be undone. All data associated with this student will be permanently deleted.
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-900">{student.name || 'No name'}</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-2">
            To confirm deletion, please type the student's email address:
          </label>
          <input
            type="email"
            value={confirmEmail}
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            disabled={confirmEmail !== student.email || isDeleting}
