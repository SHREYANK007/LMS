...
import { X, User, Mail, Phone, Calendar, UserCheck, Key, Loader2 } from 'lucide-react'
  ...
  const renderStep1 = () => (
    <div className="space-y-4">
      <div className="text-center mb-4">
        ...
        <p className="text-sm text-gray-500">Enter the student's basic details</p>
      </div>
  ...
  const renderStep2 = () => (
    <div className="space-y-4">
      <div className="text-center mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900">Course & Contact Details</h3>
        <p className="text-sm text-gray-500">Additional information for the student</p>
      </div>
